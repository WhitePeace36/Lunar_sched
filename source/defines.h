...
// #define MAX_CONTINUOUS_LC_TIME (1 * NS_PER_MS)
// #define MAX_CONTINUOUS_INTERACTIVE_TIME (2 * NS_PER_MS)
// #define MAX_CONTINUOUS_NORMAL_TIME (3 * NS_PER_MS)
// #define MAX_CONTINUOUS_BATCH_TIME (4 * NS_PER_MS)

#define MAX_CONTINUOUS_LC_TIME (1000 * NS_PER_MS)
#define MAX_CONTINUOUS_INTERACTIVE_TIME (2000 * NS_PER_MS)
#define MAX_CONTINUOUS_NORMAL_TIME (3000 * NS_PER_MS)
#define MAX_CONTINUOUS_BATCH_TIME (4000 * NS_PER_MS)
...
#define VTIME_DEBIT_FACTOR 1

#define REMAINING_SLICE_NEEDED_FOR_PREEMPT 50000LL
#define PREEMPT_KICK_INTERVAL_LIMIT 50000LL
...
#define DSQ_TYPE_LC 0
#define DSQ_TYPE_INTERACTIVE 1
#define DSQ_TYPE_NORMAL 2
#define DSQ_TYPE_BATCH 3
