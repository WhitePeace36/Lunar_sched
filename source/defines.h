...
#define STARVE_BUDGET_INTERACTIVE_NS (30ULL * NS_PER_MS)
#define STARVE_BUDGET_NORMAL_NS (40ULL * NS_PER_MS)
#define STARVE_BUDGET_GREEDY_NS (50ULL * NS_PER_MS)

#define STARVE_OVERRIDE_COOLDOWN_NS (10ULL * NS_PER_MS)
#define MIN_RUN_BEFORE_PREEMPT (500 * NS_PER_US)
