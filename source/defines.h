...
#define VLAG_PRIO_BOUNDARY_LC (10 * NS_PER_MS)
#define VLAG_PRIO_BOUNDARY_INTERACTIVE (8 * NS_PER_MS)
#define VLAG_PRIO_BOUNDARY_NORMAL (6 * NS_PER_MS)
#define VLAG_PRIO_BOUNDARY_BATCH (4 * NS_PER_MS)

// #define VLAG_PROMOTE_THRESH 2000000LL
// #define VLAG_DEMOTE_THRESH -2000000LL

#define VLAG_MIN -4000000LL
#define VLAG_MAX 12000000LL
#define SLEEP_CREDIT_DIVISOR 4LL
#define MAX_CREDITABLE_SLEEP 200000000LL
