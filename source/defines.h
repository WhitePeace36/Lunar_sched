...
#define STARVE_BUDGET_INTERACTIVE_NS (100ULL * NS_PER_MS)
#define STARVE_BUDGET_NORMAL_NS (200ULL * NS_PER_MS)
#define STARVE_BUDGET_GREEDY_NS (300ULL * NS_PER_MS)

#define STARVE_OVERRIDE_COOLDOWN_NS (10ULL * NS_PER_MS)
#define MIN_RUN_BEFORE_PREEMPT (0 * NS_PER_US)

#define SLICE_LC (800 * NS_PER_US)
#define SLICE_INTERACTIVE (2000 * NS_PER_US)
#define SLICE_NORMAL (4000 * NS_PER_US)
#define SLICE_GREEDY (8000 * NS_PER_US)

#define DUTY_INIT_RUN_NS (50ULL * NS_PER_MS)
...
#define DUTY_CAP_LC ((15 * DUTY_RANGE) / 100)
#define DUTY_CAP_INTERACTIVE ((40 * DUTY_RANGE) / 100)
#define DUTY_CAP_NORMAL ((80 * DUTY_RANGE) / 100)

#define DUTY_HYST ((3 * DUTY_RANGE) / 100)

#define CRIT_IVL_REF (1000ULL * NS_PER_MS)
#define CRIT_IVL_MIN (10ULL * NS_PER_US)
#define CRIT_MAX 40

#define CRIT_EDGE_LC 20
#define CRIT_EDGE_INTERACTIVE 10
#define CRIT_EDGE_NORMAL 3
