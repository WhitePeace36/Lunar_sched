...
#define MAX_CONTINUOUS_SOFT_TIME (4 * NS_PER_MS)
#define MAX_CONTINUOUS_LC_TIME (8 * NS_PER_MS)
#define MAX_CONTINUOUS_INTERACTIVE_TIME (12 * NS_PER_MS)
#define MAX_CONTINUOUS_NORMAL_TIME (16 * NS_PER_MS)
#define MAX_CONTINUOUS_BATCH_TIME (20 * NS_PER_MS)
