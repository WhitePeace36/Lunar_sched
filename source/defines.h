...
#define STARVE_OVERRIDE_COOLDOWN_NS (85ULL * NS_PER_MS)
#define MIN_RUN_BEFORE_PREEMPT (0 * NS_PER_US)

#define SLICE_CRTICAL (8000 * NS_PER_US)
#define SLICE_LC (8000 * NS_PER_US)
#define SLICE_INTERACTIVE (8000 * NS_PER_US)
#define SLICE_NORMAL (8000 * NS_PER_US)
#define SLICE_GREEDY (8000 * NS_PER_US)

#define DUTY_INIT_RUN_NS (50ULL * NS_PER_MS)
#define DUTY_WINDOW_NS (100ULL * NS_PER_MS)
#define DUTY_SAMPLES_NEEDED 6
