...
#define STARVE_BUDGET_INTERACTIVE_NS (3ULL * NS_PER_MS)
#define STARVE_BUDGET_NORMAL_NS (5ULL * NS_PER_MS)
#define STARVE_BUDGET_GREEDY_NS (14ULL * NS_PER_MS)

#define STARVE_OVERRIDE_COOLDOWN_NS (1ULL * NS_PER_MS)
#define MIN_RUN_BEFORE_PREEMPT (2000 * NS_PER_US)
